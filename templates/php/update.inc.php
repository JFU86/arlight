...
if ($_REQUEST["update"] == "1") {
	...
	$current_version = @file_get_contents("http://download.scripthosting.net/arlight/update/index.php");
	
	if ($current_version == "") {
		$info = "{@Die Onlineversion konnte nicht überprüft werden!}&nbsp;&nbsp;&nbsp;<img src=\"../templates/img/item.png\" alt=\"item\" /> <a href=\"http://www.scripthosting.net/?site=arlight\" target=\"_blank\">{@Selber prüfen!}</a>";	
	}
	elseif (BUILD < $current_version) {
		$info = "{@Es ist online eine neuere Version verfügbar!}&nbsp;&nbsp;&nbsp;<img src=\"../templates/img/item.png\" alt=\"item\" /> <a href=\"http://www.scripthosting.net/?site=arlight\" target=\"_blank\">{@Jetzt herunterladen!}</a>";
	}
	else {
		$info = "{@Sie besitzen bereits die aktuelle Version! Es ist kein Update notwendig.}";
	}
}
else {

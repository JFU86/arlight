...
elseif ($_REQUEST["submit"] != "" && $_REQUEST["step"] == "3") {
	...
	$_SESSION["admin_id"] = 1;
	echo "<br /><div class=\"info\" align=\"center\"><img src=\"../templates/img/s_success.png\" width=\"16\" height=\"16\" alt=\"success\" /> <b>Installation completed.</b> <u><a href=\"./\">Admin Control Panel</a></u></div><br />";
	exit;
}
// Eingabeformular
else {
	...
	if ($_REQUEST["submit"] != "") {
		if (isset($_REQUEST["noheader"])) {
			...
			echo "<br /><div class=\"errorbox\" align=\"center\"><img src=\"../templates/img/s_error.png\" width=\"16\" height=\"16\" alt=\"error\" /> <b>Please enter a <u>name</u> and a <u>password</u> !</b></div>";
	}
	...
	if ($isWritable == "No" || $safemode == "On" || version_compare(PHP_VERSION, '5.3.3') < 0 || version_compare($sqliteversion, '3.6.0') < 0) {

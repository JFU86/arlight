...
foreach ($admin->fetch() as $value) {
	...
	$list .= "<tr><td class=\"td". $i%2 ."\" style=\"width:80px;\">".
				"<a href='#' onclick='statusUser({$value["user_id"]})'><img src=\"../templates/img/b_off.gif\" alt=\"{@status}\" /> {@Status}</a><br />".
				"<a href='#' onclick='deleteUser({$value["user_id"]})'><img src=\"../templates/img/b_drop.png\" alt=\"{@löschen}\" /> {@löschen}</a></td>". "\r\n\t\t\t". 
